...
| term:pasteonmiddleclick              | bool     | set to true to paste the clipboard into the terminal on middle mouse click (defaults to false)                                                                                                                                                                |
...
| editor:copyonselect                  | bool     | set to false to disable editor copy-on-select (defaults to true)                                                                                                                                                                                              |
